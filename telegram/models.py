...
class Description(models.Model):
    description = models.TextField("Описание")
    channel = models.ForeignKey(Channel, on_delete=models.CASCADE, null=True, related_name='descriptions', verbose_name="Канал")
...
class Subscriber(models.Model):
    ...
    telegram = models.ForeignKey(Channel, on_delete=models.CASCADE, related_name='subscribers', verbose_name="Канал")
